...
<head>
	...
	<title>Cross Fit Kwetu Gym | Income per Month</title>
		...
		<div class="main-content">
			...
			<form>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<button class="btn btn-sm btn-block btn-success col-md-2 ml-1 float-right" type="button" id="print" onclick="printPage();"><i class="fa fa-print"></i> Print</button>
					</div>
				</div>
