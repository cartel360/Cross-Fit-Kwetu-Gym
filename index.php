    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header page-scroll">
                        ...
                        <a class="navbar-brand page-scroll" href="#main"><img src="images/logo.png" width="80" height="50" alt="iLand" /></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="page-scroll" href="#pricing">Packages</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <div class="main app form" id="main">
            ...
            <div class="pitch text-center" id="classes">
                <div class="container">
                    <div class="pitch-intro">
                        <h1 class="wow fadeInDown" data-wow-delay="0.2s">EVERYTHING IS POSSIBLE WITH US</h1>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            ...
                            <div class="pitch-content">
                                ...
                                <p> Get personal trainings and train at your own pace. </p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            ...
                            <div class="pitch-content">
                                ...
                                <p> Get cardio trainings anytime, anyday within our gym with proffessional cardio trainers. </p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            ...
                            <div class="pitch-content">
                                ...
                                <p> You need that training where you jump from one exercise to another... We just got that </p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            <div class="pitch-icon"> <i class="ion-ios-folder-outline"></i> </div>
                            <div class="pitch-content">
                                ...
                                <p> This is for individual who are into sports and just want to get fit. </p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            <div class="pitch-icon"> <i class="ion-ios-folder-outline"></i> </div>
                            <div class="pitch-content">
                                ...
                                <p> This is a training that involves certain muscles in the body </p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.2s">
                            <div class="pitch-icon"> <i class="ion-ios-folder-outline"></i> </div>
                            <div class="pitch-content">
                                <h1>Crossfit</h1>
                                <p> This is for individuals who want to train all round and get that perfect body and muscles to compliment it. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="app-features text-center" id="features">
                <div class="container">
                    <h1 class="wow fadeInDown" data-wow-delay="0.1s">Our promise to you</h1>
                        ...
                        <div class="reviews owl-carousel owl-theme">
                            <div class="review-single"><img class="img-circle" src="images/customer1.png" alt="Client Testimonoal" />
                                <div class="review-text wow fadeInUp" data-wow-delay="0.2s">
                                    <p>It has been good working with Cross Fit Kwetu, they have professional trainers.</p>
                                    <h3>Johnathan Doe</h3>
                                    <h3>Athlete</h3>
                                </div>
                            </div>
                            <div class="review-single"><img class="img-circle" src="images/customer2.png" alt="Client Testimonoal" />
                                <div class="review-text">
                                    <p>Since I joined Cross Fit Kwetu Gym, my training game has been upped so much.</p>
                                    <h3>Oidila Matik</h3>
                                    <h3>Security Consoltant</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="cta-sub no-color">
                <div class="container">
                    <div class="cta-inner">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.2s"> Register Below</p>
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="sign-up-htm">
                                        <form action="user_register.php" method="POST">
                                            <input type="text" name="m_id" value="<?php echo time(); ?>" hidden>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="group">
                                                        <label for="user" class="label">Username</label>
                                            ...
                                            <div class="group">
                                                <input type="submit" class="button text-center" style="margin:auto;" value="Sign Up">
                                            </div>
                                            <div class="hr"></div>
                                            <div class="foot-lnk">
            ...
            <div class="footer" id="contact">
                <div class="container">
                    <div class="col-md-6 contact">
                        <h1>About Cross Fit Kwetu Gym</h1>
                        <p>We are the Cross Fit Kwetu Gym
                        </p>
                    </div>
